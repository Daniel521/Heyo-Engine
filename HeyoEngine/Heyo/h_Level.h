...
namespace Heyo_Platform {
	...
	public:
		...
		bool loadMainCharacter(Character & main_character, unsigned int sensor_width = 0);
	...
	private: // Helper functions
		void updaterect_mc();
		void updateMCwithSensor();
		void updateMCwithoutSensor();

	private:
		enum sensor_setting_enums {disabled = 0, enabled = 1};
	...
	public:
		...
		Heyo::Point point_main_character;	// Point to draw the main character, with respect to the window
