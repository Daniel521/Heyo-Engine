...
namespace Heyo {
	...
	public:
		...
		void draw(Text& p_text, Rect destin, std::string text, Uint8 red = 255, Uint8 green = 255, Uint8 blue = 255);
		// update text, point specifies the center of the text
		void draw(Text& p_text, Point center, std::string text, double source_mult = 1.0, Uint8 red = 255, Uint8 green = 255, Uint8 blue = 255);
		void draw(Text& p_text, int x, int y, std::string text, double source_mult = 1.0, Uint8 red = 255, Uint8 green = 255, Uint8 blue = 255);
		void draw(Image& p_image, Rect destin);
		void draw(Image& p_image, Rect source, Rect destin);
		void draw(Image& p_image, Point destin);
